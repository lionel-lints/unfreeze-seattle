...
function initMap() {
  ...
  function museumMarkers() {
    museums.forEach(function(museum, index) {
      ...
      if (google.maps.geometry.poly.containsLocation(marker.position, geojsonToPolygon)) {
  ...
  function parkMarkers() {
    parks.forEach(function(park, index) {
      ...
      console.log(polygon.Contains(marker.position))
      if (polygon.Contains(marker.position)) {
...
jQuery.get(file, function(data) {
    ...
    // polygon = map.data.loadGeoJson(file);
    polygon = new google.maps.Polygon(map.data.loadGeoJson(file));
    // museumMarkers();
    parkMarkers();
    // landmarkMarkers();
